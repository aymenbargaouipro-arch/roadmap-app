export function JiraIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="jira-icon-a">
          <stop offset=".18" stopColor="#0052cc" />
          <stop offset="1" stopColor="#2684ff" />
        </linearGradient>
        <linearGradient id="jira-icon-b" x1="98.031%" x2="58.888%" y1=".161%" y2="40.766%" xlinkHref="#jira-icon-a" />
        <linearGradient id="jira-icon-c" x1="100.665%" x2="55.402%" y1=".455%" y2="44.727%" xlinkHref="#jira-icon-a" />
      </defs>
      <path
